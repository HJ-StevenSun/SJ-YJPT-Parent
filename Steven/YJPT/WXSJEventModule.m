...
-(void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary<NSString *,id> *)info
{
    ...
    [PPNetworkHelper uploadWithURL:@"http://192.168.8.6:8180/yjpt/userInfo/updateUserInfo" parameters:@{@"userId":userId} images:arr name:@"file" fileName:@"icon" mimeType:@"image/jpeg" progress:^(NSProgress *progress) {
        
    } success:^(id responseObject) {
        NSLog(@"成功%@",responseObject);
        self.path(responseObject);
